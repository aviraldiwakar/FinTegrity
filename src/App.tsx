...
export default function App() {
  ...
  const [customers, setCustomers] = useState<Customer[]>([
    { id: 1, firstName: "Harsh", lastName: "Verma", email: "h.verma@enterprise.com", cibilScore: 780, monthlyIncome: 85000 },
    { id: 2, firstName: "Ananya", lastName: "Sen", email: "ananya.sen@creditops.net", cibilScore: 610, monthlyIncome: 42000 },
    { id: 3, firstName: "Rajesh", lastName: "Mehta", email: "rajesh.mehta@fintech.org", cibilScore: 740, monthlyIncome: 25000 }
  ]);

  const [loans, setLoans] = useState<Loan[]>([
    { id: 101, customerId: 1, customerName: "Harsh Verma", loanAmount: 500000, emiAmount: 15277.78, tenureMonths: 36, loanStatus: 'APPROVED' }
  ]);

  const [transactions, setTransactions] = useState<Transaction[]>([
    { id: 201, loanId: 101, customerName: "Harsh Verma", amount: 15277.78, dueDate: "2026-07-19", paymentDate: null, status: 'PENDING' },
    { id: 202, loanId: 101, customerName: "Harsh Verma", amount: 15277.78, dueDate: "2026-08-19", paymentDate: null, status: 'PENDING' },
    // Past due to demonstrate initial late flagging/re-risk matching
    { id: 203, loanId: 101, customerName: "Harsh Verma", amount: 15277.78, dueDate: "2026-05-15", paymentDate: null, status: 'PENDING' }
  ]);
